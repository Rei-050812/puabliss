    ...
    <>
      ...
      >
        <div className="max-w-5xl mx-auto px-5 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-7">
            {NAV_ITEMS.map((item) => (
              <button
                ...
                className="text-xs text-[#4d6b44] hover:text-[#3d5b34] transition-colors tracking-wide"
              >
                {item.label}
              </button>
            ))}
            <a
              ...
              className="bg-[#4d6b44] text-white text-xs font-bold px-4 py-2 rounded-full hover:bg-[#3d5b34] transition-colors border border-[#4d6b44]"
            >
              LINEで予約
            </a>
          </nav>
          ...
          >
            <span
              className={`block w-5 h-0.5 bg-[#4d6b44] rounded transition-all duration-300 ${
